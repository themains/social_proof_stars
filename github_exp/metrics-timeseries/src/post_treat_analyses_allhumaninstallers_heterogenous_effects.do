...
foreach het_var of local hetvars {
    ...
    local savepath "../output/github_exp_medians_regtable_allhumaninstallers_`het_var'.tex"
    #delimit ;
...
foreach het_var of local hetvars {
    ...
    local savepath "../output/github_exp_het_`het_var'_late.tex"
    #delimit ;
    esttab using "`savepath'",
        cell(
            b (fmt(`fmt') star)
...
foreach het_var of local pkg_complex {
    ...
    local savepath "../output/github_exp_continuous_regtable_allhumaninstallers_`het_var'.tex"
    #delimit ;
    esttab using "`savepath'",
        cell(
            b (fmt(`fmt') star)
...
foreach het_var of local pkg_complex {
    ...
    local savepath "../output/github_exp_continuous_het_`het_var'_late.tex"
    #delimit ;
    esttab using "`savepath'",
        cell(
            b (fmt(`fmt') star)
