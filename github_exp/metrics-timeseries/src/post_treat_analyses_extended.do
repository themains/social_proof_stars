...
* --------------------------------------------------------------
* Snapshot at Jul 20 (2 months relative to May 20 end of treatment period)
...
* --------------------------------------------------------------
* Snapshot at Aug 20 (3 months relative to May 20 end of treatment period)
...
* --------------------------------------------------------------
* Snapshot at Sep 20 (4 months relative to May 20 end of treatment period)
...
* --------------------------------------------------------------
* Snapshot at Oct 20 (5 months relative to May 20 end of treatment period)
...
local savepath using ../output/github_exp_means_regtable_extended.tex
local fmt %9.1f
#delimit;
esttab `savepath',
	cell(
...
local savepath using ../output/github_exp_medians_regtable_extended.tex
local fmt %9.1f
#delimit;
esttab `savepath',
	cell(
